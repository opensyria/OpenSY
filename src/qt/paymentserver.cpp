...
const QString BITCOIN_IPC_PREFIX("opensyria:");
...
void PaymentServer::handleURIOrFile(const QString& s)
{
    ...
    if (s.startsWith("opensyria://", Qt::CaseInsensitive))
    {
        Q_EMIT message(tr("URI handling"), tr("'opensyria://' is not a valid URI. Use 'bitcoin:' instead."),
    ...
    else if (s.startsWith(BITCOIN_IPC_PREFIX, Qt::CaseInsensitive)) // bitcoin: URI
    {
        ...
        // normal URI
        {
            ...
            if (GUIUtil::parseOpenSyriaURI(s, &recipient))
            {
