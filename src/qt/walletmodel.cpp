...
bool WalletModel::bumpFee(Txid hash, Txid& new_hash)
{
    ...
    questionString.append(OpenSyriaUnits::formatHtmlWithUnit(getOptionsModel()->getDisplayUnit(), old_fee));
    questionString.append("</td></tr><tr><td>");
    questionString.append(tr("Increase:"));
    questionString.append("</td><td>");
    questionString.append(OpenSyriaUnits::formatHtmlWithUnit(getOptionsModel()->getDisplayUnit(), new_fee - old_fee));
    questionString.append("</td></tr><tr><td>");
    questionString.append(tr("New fee:"));
    questionString.append("</td><td>");
    questionString.append(OpenSyriaUnits::formatHtmlWithUnit(getOptionsModel()->getDisplayUnit(), new_fee));
