...
static RPCHelpMan validateaddress()
{
    return RPCHelpMan{
        "validateaddress",
        "Return information about the given opensyria address.\n",
        {
            {"address", RPCArg::Type::STR, RPCArg::Optional::NO, "The opensyria address to validate"},
        },
        RPCResult{
            RPCResult::Type::OBJ, "", "",
            {
                {RPCResult::Type::BOOL, "isvalid", "If the address is valid or not"},
                {RPCResult::Type::STR, "address", /*optional=*/true, "The opensyria address validated"},
