...
#ifndef OPENSYRIA_RPC_PROTOCOL_H
#define OPENSYRIA_RPC_PROTOCOL_H
...
enum RPCErrorCode
{
    ...
    // RPC_INTERNAL_ERROR should only be used for genuine errors in opensyriad
    ...
    //! P2P client errors
    RPC_CLIENT_NOT_CONNECTED        = -9,  //!< OpenSyria is not connected
...
#endif // OPENSYRIA_RPC_PROTOCOL_H
