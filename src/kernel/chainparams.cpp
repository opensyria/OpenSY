...
public:
    CTestNetParams() {
        ...
        bech32_hrp = "tsyl"; // OpenSY testnet4 SegWit
...
public:
    explicit SigNetParams(const SigNetOptions& options)
    {
        ...
        if (!options.challenge) {
            // TODO: Generate OpenSY-specific signet challenge keys
            // For now, using a placeholder - replace with actual OpenSY signet keys before launch
            bin = "512103ad5e0edad18cb1f0fc0d28a3d4f1f3e445640337489abb10404f2d1e086be430210359ef5021964fe22d6f8e05b2463c9540ce96883fe3b278760f048f5189f2e6c452ae"_hex_v_u8;
            vFixedSeeds.clear(); // No fixed seeds until OpenSY signet nodes are established
            vSeeds.clear(); // DNS seeds cleared until OpenSY signet infrastructure is established
