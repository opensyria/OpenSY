...
{
    const char* pszTimestamp = "OpenSyria - First Syrian Blockchain - For Syria Future and Reconstruction 2025";
...
public:
    CMainParams() {
        ...
        base58Prefixes[SCRIPT_ADDRESS] = std::vector<unsigned char>(1,23); // Addresses start with 'D' (Damascus)
...
public:
    CTestNet4Params() {
        ...
        genesis = CreateGenesisBlock(testnet4_genesis_msg,
                ...
                10000 * COIN);
        consensus.hashGenesisBlock = genesis.GetHash();
        // TODO: Update after mining new genesis: assert(consensus.hashGenesisBlock == uint256{"00000000da84f2bafbbc53dee25a72ae507ff4914b867c565be350b0da8bf043"});
        // TODO: Update after mining new genesis: assert(genesis.hashMerkleRoot == uint256{"7aa0a7ae1e223414cb807e40cd57e667b718e42aaf9306db9102fe28912b7b4e"});
