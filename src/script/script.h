...
#ifndef OPENSYRIA_SCRIPT_SCRIPT_H
#define OPENSYRIA_SCRIPT_SCRIPT_H
...
public:
    ...
    /**
     * Pre-version-0.6, OpenSyria always counted CHECKMULTISIGs
...
#endif // OPENSYRIA_SCRIPT_SCRIPT_H
