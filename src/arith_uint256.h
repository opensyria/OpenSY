...
#ifndef OPENSYRIA_ARITH_UINT256_H
#define OPENSYRIA_ARITH_UINT256_H
...
public:
     ...
     *
     * OpenSyria only uses this "compact" format for encoding difficulty
...
#endif // OPENSYRIA_ARITH_UINT256_H
