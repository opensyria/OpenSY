...
When complete, it will have produced `OpenSyria-Core.zip`.
...
apt install cpio
# Note: apple-sdk-tools can be used from bitcoin-core as it's a generic utility
...
- The Apple keyholder uses this unsigned app to create a detached signature, using the
  included script. Detached signatures are available from this [repository](https://github.com/opensyria/opensyria-detached-sigs).
