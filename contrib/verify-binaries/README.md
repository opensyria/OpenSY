...
As of OpenSY v22.0, releases are signed by a number of public keys on the basis
...
builder-keys](https://github.com/opensyria/guix.sigs/tree/main/builder-keys) and
...
signature file `SHA256SUMS.asc` from https://opensy.net.
...
./contrib/verify-binaries/verify.py bin ~/Downloads/SHA256SUMS \
    ~/Downloads/opensy-24.0.1-x86_64-linux-gnu.tar.gz \
    ~/Downloads/opensy-24.0.1-arm-linux-gnueabihf.tar.gz
```
