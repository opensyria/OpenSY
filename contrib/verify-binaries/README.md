...
signature file `SHA256SUMS.asc` from https://opensyriacore.org and https://opensyria.org.
...
./contrib/verify-binaries/verify.py bin ~/Downloads/SHA256SUMS \
    ~/Downloads/opensyria-24.0.1-x86_64-linux-gnu.tar.gz \
    ~/Downloads/opensyria-24.0.1-arm-linux-gnueabihf.tar.gz
```
