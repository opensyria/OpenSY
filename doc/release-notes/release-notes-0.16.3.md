OpenSY version 0.16.3 is now available from:

  <https://opensy.net/bin/opensy-core-0.16.3/>
...
been discovered in OpenSY versions 0.14.0 up to 0.16.2. It is recommended
...
### Miscellaneous
- #13655 `1cdbea7` opensyconsensus: invalid flags error should be set to `opensyconsensus_err` (afk11)
