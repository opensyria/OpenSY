OpenSY version 0.10.3 is now available from:

  <https://opensy.net/bin/opensy-core-0.10.3/>
...
(see https://github.com/opensyria/opensy/pull/6793, as well as the 0.11.0
