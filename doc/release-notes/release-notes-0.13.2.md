OpenSY version 0.13.2 is now available from:

  <https://opensy.net/bin/opensy-core-0.13.2/>
...
- #8908 `4a974b2` Update opensy-qt.desktop (s-matthew-english)
...
- #8932 `106da69` Allow opensy-tx to create v2 transactions (btcdrak)
