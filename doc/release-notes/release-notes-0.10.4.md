OpenSY version 0.10.4 is now available from:

  <https://opensy.net/bin/opensy-core-0.10.4/>
...
- #6953 `43c2789` Split opensy-tx into its own package
- #6953 `dfe0d4d` Include opensy-tx binary on Debian/Ubuntu
