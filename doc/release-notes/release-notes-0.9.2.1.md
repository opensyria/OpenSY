OpenSY version 0.9.2.1 is now available from:

  https://opensy.net/bin/0.9.2.1/
...
- Lower paytxfee warning threshold from 0.25 SYL to 0.01 SYL
...
- Fix "Start opensy on system login"
