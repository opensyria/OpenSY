OpenSY version 0.16.1 is now available from:

  <https://opensy.net/bin/opensy-core-0.16.1/>
...
- #12843 `df38b13` Test starting opensyd with -h and -version (jnewbery)
...
- #12904 `6c26df0` Ensure opensyd processes are cleaned up when tests end (sdaftuar)
