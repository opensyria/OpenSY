OpenSY-Qt version 0.8.0 is now available from:
  http://sourceforge.net/projects/opensy/files/OpenSY/opensy-0.8.0/
...
Mac and Windows binaries are signed with certificates owned by the OpenSY
...
New/changed settings (command-line or opensy.conf file)
--------------------------------------------------------
