...
OpenSY versions 0.14.0 up to 0.16.2. It is recommended to upgrade any of
...
- #10451 `3612219` contrib/init/opensyd.openrcconf: Don't disable wallet by default (Luke Dashjr)
