...
```sh
cmake --build build --target opensyd opensy-cli
cmake --build build --target opensy-qt
cmake --build build --target bench_opensy
```
...
[remote "upstream-pull"]
        ...
        url = git@github.com:opensy/opensy.git
```
...
> e.g. github.com/opensyria/opensy.git or for the GUI github.com/opensy-core/gui
