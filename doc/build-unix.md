UNIX BUILD NOTES
====================
Some notes on how to build OpenSY in Unix.
...
memory available when compiling OpenSY. On systems with less, gcc can be
...
To build OpenSY without the wallet, see [*Disable-wallet mode*](#disable-wallet-mode)
...
Disable-wallet mode
--------------------
When the intention is to only run a P2P node, without a wallet, OpenSY can
