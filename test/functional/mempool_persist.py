...
By default, opensyriad will dump mempool on shutdown and
...
class MempoolPersistTest(OpenSyriaTestFramework):
    ...
    def run_test(self):
        ...
        self.log.debug("Prevent opensyriad from writing mempool.dat to disk. Verify that `savemempool` fails")
