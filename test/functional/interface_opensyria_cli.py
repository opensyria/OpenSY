...
WALLET_NOT_SPECIFIED = (
    ...
    "option before the command (run \"opensyria-cli -h\" for help or \"opensyria-cli listwallets\" to see "
...
class TestOpenSyriaCli(OpenSyriaTestFramework):
    ...
    def run_test(self):
        ...
        self.log.info("Compare responses from getblockchaininfo RPC and `opensyria-cli getblockchaininfo`")
        ...
        # Prevent opensyria-cli from using existing rpcport in conf
        ...
        self.log.info("Test -getinfo and opensyria-cli return all proxies")
        ...
        if self.is_wallet_compiled():
            self.log.info("Test -getinfo and opensyria-cli getwalletinfo return expected wallet info")
            ...
            # Test opensyria-cli -generate with -rpcwallet in multiwallet mode.
...
if __name__ == '__main__':
    TestOpenSyriaCli(__file__).main()
